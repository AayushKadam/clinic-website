    ...
    this.innerHTML = `
        ...
        <div class="nav-container container">
          ...
          <nav class="nav-menu">
            <ul class="nav-list">
              ...
              <li class="nav-item"><a href="social-hub.html" class="nav-link">Social Hub</a></li>
              <li class="nav-item"><a href="booking.html" class="nav-link">Book Appointment</a></li>
      ...
      <div class="mobile-drawer" id="mobile-drawer">
        ...
        <ul class="drawer-list">
          <li><a href="services.html" class="drawer-link">Services</a></li>
          <li><a href="doctors.html" class="drawer-link">Our Doctors</a></li>
          <li><a href="social-hub.html" class="drawer-link">Social Hub</a></li>
          <li><a href="booking.html" class="drawer-link">Book Appointment</a></li>
      ...
      <a href="booking.html" class="floating-booking-btn" aria-label="Book Appointment">
